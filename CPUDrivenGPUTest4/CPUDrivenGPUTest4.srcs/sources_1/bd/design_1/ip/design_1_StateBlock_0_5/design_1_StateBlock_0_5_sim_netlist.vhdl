...
-- Date        : Thu Oct 10 01:00:43 2024
-- Host        : Dragon2 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/Xilinx/MyXilinxProjects/CPUDrivenGPUTest3/CPUDrivenGPUTest3.srcs/sources_1/bd/design_1/ip/design_1_StateBlock_0_5/design_1_StateBlock_0_5_sim_netlist.vhdl
-- Design      : design_1_StateBlock_0_5
...
entity design_1_StateBlock_0_5_StateBlock is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_StateBlock_0_5_StateBlock : entity is "StateBlock";
end design_1_StateBlock_0_5_StateBlock;

architecture STRUCTURE of design_1_StateBlock_0_5_StateBlock is
  ...
  signal \slotsData_reg[0][SlotData]\ : STD_LOGIC_VECTOR ( 34 downto 0 );
  signal \slotsData_reg[1][SlotData]\ : STD_LOGIC_VECTOR ( 34 downto 0 );
  signal \slotsData_reg[2][SlotData]\ : STD_LOGIC_VECTOR ( 34 downto 0 );
  signal \slotsData_reg[3][SlotData]\ : STD_LOGIC_VECTOR ( 34 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \CMD_NumFreeSlots[0]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \CMD_NumFreeSlots[2]_INST_0\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \slotsData[2][SlotDrawEventID][0]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \slotsData[2][SlotDrawEventID][4]_i_1\ : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \slotsData[3][SlotDrawEventID][4]_i_1\ : label is "soft_lutpair20";
...
\slotsData[0][SlotData][34]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\slotsData[1][SlotData][34]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
...
\slotsData[2][SlotData][34]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
...
\slotsData[3][SlotData][34]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
entity design_1_StateBlock_0_5 is
  ...
  attribute NotValidForBitStream of design_1_StateBlock_0_5 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_StateBlock_0_5 : entity is "design_1_StateBlock_0_5,StateBlock,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_StateBlock_0_5 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_StateBlock_0_5 : entity is "StateBlock,Vivado 2018.1_AR73068";
end design_1_StateBlock_0_5;

architecture STRUCTURE of design_1_StateBlock_0_5 is
...
begin
U0: entity work.design_1_StateBlock_0_5_StateBlock
     port map (
      CMD_EndFrameReset => CMD_EndFrameReset,
      CMD_NewStateBits(34 downto 0) => CMD_NewStateBits(34 downto 0),
      ...
      STAGE_StateBitsAtDrawID(34 downto 0) => STAGE_StateBitsAtDrawID(34 downto 0),
