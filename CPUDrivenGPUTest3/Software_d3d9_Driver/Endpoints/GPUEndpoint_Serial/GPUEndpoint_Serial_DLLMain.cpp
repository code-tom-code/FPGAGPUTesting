...
#include "..\\..\\Software_d3d9_Driver\\Driver\\ISerialDeviceComms.h"
...
static ISerialDeviceComms* serialDevice = NULL;
...
bool __stdcall InitEndpointImpl(const ReturnMessageSignature D2HReplyCallback)
{
	...
	serialDevice = new ISerialDeviceComms("COM3", 921600, ODDPARITY);
