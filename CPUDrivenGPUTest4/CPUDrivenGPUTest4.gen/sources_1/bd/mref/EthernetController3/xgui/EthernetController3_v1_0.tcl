...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "UDP_PROTOCOL_PORT_D2H" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_PROTOCOL_PORT_H2D" -parent ${Page_0}
...
proc update_PARAM_VALUE.UDP_PROTOCOL_PORT_D2H { PARAM_VALUE.UDP_PROTOCOL_PORT_D2H } {
	# Procedure called to update UDP_PROTOCOL_PORT_D2H when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.UDP_PROTOCOL_PORT_D2H { PARAM_VALUE.UDP_PROTOCOL_PORT_D2H } {
	# Procedure called to validate UDP_PROTOCOL_PORT_D2H
	return true
}

proc update_PARAM_VALUE.UDP_PROTOCOL_PORT_H2D { PARAM_VALUE.UDP_PROTOCOL_PORT_H2D } {
	# Procedure called to update UDP_PROTOCOL_PORT_H2D when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.UDP_PROTOCOL_PORT_H2D { PARAM_VALUE.UDP_PROTOCOL_PORT_H2D } {
	# Procedure called to validate UDP_PROTOCOL_PORT_H2D
	return true
}
...
proc update_MODELPARAM_VALUE.UDP_PROTOCOL_PORT_D2H { MODELPARAM_VALUE.UDP_PROTOCOL_PORT_D2H PARAM_VALUE.UDP_PROTOCOL_PORT_D2H } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.UDP_PROTOCOL_PORT_D2H}] ${MODELPARAM_VALUE.UDP_PROTOCOL_PORT_D2H}
}

proc update_MODELPARAM_VALUE.UDP_PROTOCOL_PORT_H2D { MODELPARAM_VALUE.UDP_PROTOCOL_PORT_H2D PARAM_VALUE.UDP_PROTOCOL_PORT_H2D } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.UDP_PROTOCOL_PORT_H2D}] ${MODELPARAM_VALUE.UDP_PROTOCOL_PORT_H2D}
}
