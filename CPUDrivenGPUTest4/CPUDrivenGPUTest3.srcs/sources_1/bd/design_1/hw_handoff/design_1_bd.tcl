...
proc create_hier_cell_ShaderCoreSystem { parentCell nameHier } {
  ...
  create_bd_pin -dir O CMD_IsIdle
  ...
  create_bd_pin -dir O -from 15 -to 0 STAT_CurrentDrawEventID
  ...
  create_bd_pin -dir I VERTBATCH_FIFO_empty
  create_bd_pin -dir O VERTBATCH_FIFO_rd_en
  ...
  connect_bd_net -net ShaderCore_0_CMD_IsIdle [get_bd_pins CMD_IsIdle] [get_bd_pins ShaderCore_0/CMD_IsIdle]
  ...
  connect_bd_net -net ShaderCore_0_STAT_CurrentDrawEventID [get_bd_pins STAT_CurrentDrawEventID] [get_bd_pins ShaderCore_0/STAT_CurrentDrawEventID]
  ...
  connect_bd_net -net ShaderCore_0_VERTBATCH_FIFO_rd_en [get_bd_pins VERTBATCH_FIFO_rd_en] [get_bd_pins ShaderCore_0/VERTBATCH_FIFO_rd_en]
  ...
  connect_bd_net -net VERTBATCH_FIFO_empty_1 [get_bd_pins VERTBATCH_FIFO_empty] [get_bd_pins ShaderCore_0/VERTBATCH_FIFO_empty]
...
# Hierarchical cell: NetworkPacketSystem
proc create_hier_cell_NetworkPacketSystem { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_NetworkPacketSystem() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 refclk625_in_0
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:sgmii_rtl:1.0 sgmii_lvds

  # Create pins
  create_bd_pin -dir I -type clk clk333_250

  # Create instance: CDC_EthernetControll_0, and set properties
  set block_name CDC_EthernetController_NetPktProcessor
  set block_cell_name CDC_EthernetControll_0
  if { [catch {set CDC_EthernetControll_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CDC_EthernetControll_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: CDC_EthernetControll_1, and set properties
  set block_name CDC_EthernetController_NetPktProcessor
  set block_cell_name CDC_EthernetControll_1
  if { [catch {set CDC_EthernetControll_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CDC_EthernetControll_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set EthernetController3_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.DEVICE_IPv4_ADDRESS_OCTET_3 {0xAB} \
  ...
  # Create instance: NetProtoSendRetransmitBRAM, and set properties
  set NetProtoSendRetransmitBRAM [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 NetProtoSendRetransmitBRAM ]
  set_property -dict [ list \
  ...
  # Create instance: clk_333_250_to_10_0, and set properties
  set clk_333_250_to_10_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_333_250_to_10_0 ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {30.0} \
   CONFIG.CLKOUT1_JITTER {347.689} \
   ...
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {107.500} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.Empty_Threshold_Assert_Value {4} \
   CONFIG.Empty_Threshold_Negate_Value {5} \
   CONFIG.Full_Threshold_Assert_Value {345} \
   CONFIG.Full_Threshold_Negate_Value {344} \
   CONFIG.Input_Data_Width {88} \
   CONFIG.Input_Depth {512} \
   CONFIG.Output_Data_Width {88} \
   CONFIG.Output_Depth {512} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins mdio_mdc] [get_bd_intf_pins gig_ethernet_pcs_pma_0/ext_mdio_pcs_pma_0]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins sgmii_lvds] [get_bd_intf_pins gig_ethernet_pcs_pma_0/sgmii_0]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins FIFO_READ] [get_bd_intf_pins validPacketsFIFO/FIFO_READ]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins FIFO_WRITE] [get_bd_intf_pins returnPacketsFIFO/FIFO_WRITE]
  ...
  connect_bd_intf_net -intf_net NetProtoPacketProces_0_SendPacketBRAMR [get_bd_intf_pins NetProtoPacketProces_0/SendPacketBRAMR] [get_bd_intf_pins NetProtoSendRetransmitBRAM/BRAM_PORTB]
  connect_bd_intf_net -intf_net NetProtoPacketProces_0_SendPacketBRAMW [get_bd_intf_pins NetProtoPacketProces_0/SendPacketBRAMW] [get_bd_intf_pins NetProtoSendRetransmitBRAM/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net sgmii_phyclk_1 [get_bd_intf_pins refclk625_in_0] [get_bd_intf_pins gig_ethernet_pcs_pma_0/refclk625_in]

  # Create port connections
  connect_bd_net -net CDC_EthernetControll_0_Out_Signal [get_bd_pins CDC_EthernetControll_0/Out_Signal] [get_bd_pins NetProtoPacketProces_0/ETHCTRL_RecvReady]
  connect_bd_net -net CDC_EthernetControll_1_Out_Signal [get_bd_pins CDC_EthernetControll_1/Out_Signal] [get_bd_pins NetProtoPacketProces_0/ETHCTRL_SendReady]
  ...
  connect_bd_net -net EthernetController3_0_NETPKT_RecvReady [get_bd_pins CDC_EthernetControll_0/In_Signal] [get_bd_pins EthernetController3_0/NETPKT_RecvReady]
  connect_bd_net -net EthernetController3_0_NETPKT_SendReady [get_bd_pins CDC_EthernetControll_1/In_Signal] [get_bd_pins EthernetController3_0/NETPKT_SendReady]
  connect_bd_net -net EthernetController3_0_STAT_CountDroppedRecvPackets [get_bd_pins EthernetController3_0/STAT_CountDroppedRecvPackets] [get_bd_pins ila_0/probe4]
  connect_bd_net -net EthernetController3_0_STAT_CountInvalidRecvPackets [get_bd_pins EthernetController3_0/STAT_CountInvalidRecvPackets] [get_bd_pins ila_0/probe3]
  connect_bd_net -net EthernetController3_0_STAT_CountSendUdpPackets [get_bd_pins EthernetController3_0/STAT_CountSendUdpPackets] [get_bd_pins ila_0/probe0]
  connect_bd_net -net EthernetController3_0_STAT_CountValidRecvArpPackets [get_bd_pins EthernetController3_0/STAT_CountValidRecvArpPackets] [get_bd_pins ila_0/probe2]
  connect_bd_net -net EthernetController3_0_STAT_CountValidRecvUdpPackets [get_bd_pins EthernetController3_0/STAT_CountValidRecvUdpPackets] [get_bd_pins ila_0/probe1]
  ...
  connect_bd_net -net EthernetMDIOControll_0_mdio_t_ctrl [get_bd_pins EthernetMDIOControll_0/mdio_t_ctrl] [get_bd_pins gig_ethernet_pcs_pma_0/mdio_t_in_0]
  connect_bd_net -net EthernetMDIOControll_0_registerReadData [get_bd_pins EthernetMDIOControll_0/registerReadData] [get_bd_pins SGMII_PHY_Bringup_MD_0/registerReadData]
  connect_bd_net -net EthernetMDIOControll_0_registerReadReady [get_bd_pins EthernetMDIOControll_0/registerReadReady] [get_bd_pins SGMII_PHY_Bringup_MD_0/registerReadReady]
  ...
  connect_bd_net -net NetProtoPacketProces_0_validPacketsFIFO_wr_data [get_bd_pins NetProtoPacketProces_0/validPacketsFIFO_wr_data] [get_bd_pins validPacketsFIFO/din]
  connect_bd_net -net NetProtoPacketProces_0_validPacketsFIFO_wr_en [get_bd_pins NetProtoPacketProces_0/validPacketsFIFO_wr_en] [get_bd_pins validPacketsFIFO/wr_en]
  ...
  connect_bd_net -net SGMII_PHY_Bringup_MD_0_newRequestDevTypeRegister [get_bd_pins EthernetMDIOControll_0/newRequestDevTypeRegister] [get_bd_pins SGMII_PHY_Bringup_MD_0/newRequestDevTypeRegister]
  ...
  connect_bd_net -net SGMII_PHY_Bringup_MD_0_newRequestPHYAddress [get_bd_pins EthernetMDIOControll_0/newRequestPHYAddress] [get_bd_pins SGMII_PHY_Bringup_MD_0/newRequestPHYAddress]
  ...
  connect_bd_net -net clk333_250_1 [get_bd_pins clk333_250] [get_bd_pins CDC_EthernetControll_0/Out_clk333] [get_bd_pins CDC_EthernetControll_1/Out_clk333] [get_bd_pins NetProtoPacketProces_0/clk333_250] [get_bd_pins clk_333_250_to_10_0/clk_in1] [get_bd_pins recv_pkt_data_fifo/rd_clk] [get_bd_pins recv_pkt_header_fifo/rd_clk] [get_bd_pins returnPacketsFIFO/clk] [get_bd_pins send_pkt_data_fifo/wr_clk] [get_bd_pins send_pkt_header_fifo/wr_clk] [get_bd_pins validPacketsFIFO/clk]
  connect_bd_net -net clk_333_250_to_10_0_clk_out1 [get_bd_pins ClockDivider4_1_0/clkin100] [get_bd_pins clk_333_250_to_10_0/clk_out1]
  connect_bd_net -net gig_ethernet_pcs_pma_0_clk125_out [get_bd_pins CDC_EthernetControll_0/In_clk125] [get_bd_pins CDC_EthernetControll_1/In_clk125] [get_bd_pins EthernetController3_0/clk125] [get_bd_pins gig_ethernet_pcs_pma_0/clk125_out] [get_bd_pins ila_0/clk] [get_bd_pins recv_pkt_data_fifo/wr_clk] [get_bd_pins recv_pkt_header_fifo/wr_clk] [get_bd_pins send_pkt_data_fifo/rd_clk] [get_bd_pins send_pkt_header_fifo/rd_clk]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_isolate_0 [get_bd_pins EthernetController3_0/gmii_isolate] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_isolate_0]
  connect_bd_net -net gig_ethernet_pcs_pma_0_rx_locked [get_bd_pins EthernetController3_0/rx_locked] [get_bd_pins gig_ethernet_pcs_pma_0/rx_locked]
  connect_bd_net -net gig_ethernet_pcs_pma_0_status_vector_0 [get_bd_pins EthernetController3_0/status_vector] [get_bd_pins gig_ethernet_pcs_pma_0/status_vector_0]
  connect_bd_net -net gig_ethernet_pcs_pma_0_tx_locked [get_bd_pins EthernetController3_0/tx_locked] [get_bd_pins gig_ethernet_pcs_pma_0/tx_locked]
  ...
  connect_bd_net -net validPacketsFIFO_full [get_bd_pins NetProtoPacketProces_0/validPacketsFIFO_full] [get_bd_pins validPacketsFIFO/full]
  connect_bd_net -net validPacketsFIFO_prog_full [get_bd_pins NetProtoPacketProces_0/validPacketsFIFO_prog_full] [get_bd_pins validPacketsFIFO/prog_full]
...
proc create_root_design { parentCell } {
  ...
  set ext_mdio_pcs_pma_0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:mdio_rtl:1.0 ext_mdio_pcs_pma_0_0 ]
  set sgmii_0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:sgmii_rtl:1.0 sgmii_0_0 ]
  ...
  # Create instance: ATTRINTERP_TRIDATA_FIFO, and set properties
  set ATTRINTERP_TRIDATA_FIFO [ create_bd_cell -type ip -vlnv xilinx.com:ip:fifo_generator:13.2 ATTRINTERP_TRIDATA_FIFO ]
  set_property -dict [ list \
   CONFIG.Data_Count_Width {9} \
   CONFIG.Empty_Threshold_Assert_Value {4} \
   CONFIG.Empty_Threshold_Negate_Value {5} \
   CONFIG.Full_Threshold_Assert_Value {511} \
   CONFIG.Full_Threshold_Negate_Value {510} \
   CONFIG.Input_Data_Width {576} \
   CONFIG.Input_Depth {512} \
   CONFIG.Output_Data_Width {576} \
   CONFIG.Output_Depth {512} \
   CONFIG.Performance_Options {First_Word_Fall_Through} \
   CONFIG.Read_Data_Count_Width {9} \
   CONFIG.Use_Embedded_Registers {false} \
   CONFIG.Write_Data_Count_Width {9} \
 ] $ATTRINTERP_TRIDATA_FIFO

  # Create instance: ATTR_FIFO, and set properties
  set ATTR_FIFO [ create_bd_cell -type ip -vlnv xilinx.com:ip:fifo_generator:13.2 ATTR_FIFO ]
  set_property -dict [ list \
   CONFIG.Data_Count_Width {9} \
   CONFIG.Empty_Threshold_Assert_Value {4} \
   CONFIG.Empty_Threshold_Negate_Value {5} \
  ...
  # Create instance: AttrInterpStateBlock, and set properties
  set block_name StateBlock
  set block_cell_name AttrInterpStateBlock
  if { [catch {set AttrInterpStateBlock [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AttrInterpStateBlock eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: AttrInterp_FPU_MUL, and set properties
  set block_name StandaloneFloatALU_MUL
  set block_cell_name AttrInterp_FPU_MUL
  if { [catch {set AttrInterp_FPU_MUL [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AttrInterp_FPU_MUL eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: ClipUnitStateBlock, and set properties
  set block_name StateBlock
  set block_cell_name ClipUnitStateBlock
  if { [catch {set ClipUnitStateBlock [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ClipUnitStateBlock eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.StateBitsCount {11} \
 ] $ClipUnitStateBlock
  ...
  # Create instance: DINTERP_FPU_CNV0, and set properties
  set block_name StandaloneFloatALU_CNV
  set block_cell_name DINTERP_FPU_CNV0
  if { [catch {set DINTERP_FPU_CNV0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DINTERP_FPU_CNV0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: DINTERP_FPU_CNV1, and set properties
  set block_name StandaloneFloatALU_CNV
  set block_cell_name DINTERP_FPU_CNV1
  if { [catch {set DINTERP_FPU_CNV1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DINTERP_FPU_CNV1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: DINTERP_FPU_MUL, and set properties
  set block_name StandaloneFloatALU_MUL
  set block_cell_name DINTERP_FPU_MUL
  if { [catch {set DINTERP_FPU_MUL [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DINTERP_FPU_MUL eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: DINTERP_FPU_SPEC, and set properties
  set block_name StandaloneFloatALU_SPEC
  set block_cell_name DINTERP_FPU_SPEC
  if { [catch {set DINTERP_FPU_SPEC [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DINTERP_FPU_SPEC eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: DINTERP_TRIDATA_FIFO, and set properties
  set DINTERP_TRIDATA_FIFO [ create_bd_cell -type ip -vlnv xilinx.com:ip:fifo_generator:13.2 DINTERP_TRIDATA_FIFO ]
  set_property -dict [ list \
   CONFIG.Data_Count_Width {9} \
   CONFIG.Empty_Threshold_Assert_Value {4} \
   CONFIG.Empty_Threshold_Negate_Value {5} \
   CONFIG.Full_Threshold_Assert_Value {511} \
   CONFIG.Full_Threshold_Negate_Value {510} \
   CONFIG.Input_Data_Width {224} \
   CONFIG.Input_Depth {512} \
   CONFIG.Output_Data_Width {224} \
   CONFIG.Output_Depth {512} \
   CONFIG.Performance_Options {First_Word_Fall_Through} \
   CONFIG.Read_Data_Count_Width {9} \
   CONFIG.Use_Embedded_Registers {false} \
   CONFIG.Write_Data_Count_Width {9} \
 ] $DINTERP_TRIDATA_FIFO
  ...
  # Create instance: InputAssemblerStateBlock, and set properties
  set block_name StateBlock
  set block_cell_name InputAssemblerStateBlock
  if { [catch {set InputAssemblerStateBlock [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $InputAssemblerStateBlock eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.StateBitsCount {5} \
 ] $InputAssemblerStateBlock

  # Create instance: MemorySystem
  create_hier_cell_MemorySystem [current_bd_instance .] MemorySystem

  # Create instance: NetworkPacketSystem
  create_hier_cell_NetworkPacketSystem [current_bd_instance .] NetworkPacketSystem

  # Create instance: ROPStateBlock, and set properties
  set block_name StateBlock
  set block_cell_name ROPStateBlock
  if { [catch {set ROPStateBlock [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ROPStateBlock eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.StateBitsCount {101} \
 ] $ROPStateBlock
  ...
  # Create instance: StatsWriteOrderNibblesFIFO, and set properties
  set StatsWriteOrderNibblesFIFO [ create_bd_cell -type ip -vlnv xilinx.com:ip:fifo_generator:13.2 StatsWriteOrderNibblesFIFO ]
  set_property -dict [ list \
   CONFIG.Data_Count_Width {13} \
   CONFIG.Empty_Threshold_Assert_Value {4} \
   CONFIG.Empty_Threshold_Negate_Value {5} \
   CONFIG.Full_Threshold_Assert_Value {8188} \
   CONFIG.Full_Threshold_Negate_Value {8187} \
  ...
  # Create instance: TexSampleStateBlock, and set properties
  set block_name StateBlock
  set block_cell_name TexSampleStateBlock
  if { [catch {set TexSampleStateBlock [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $TexSampleStateBlock eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.StateBitsCount {74} \
 ] $TexSampleStateBlock
  ...
  # Create instance: TriSetupStateBlock, and set properties
  set block_name StateBlock
  set block_cell_name TriSetupStateBlock
  if { [catch {set TriSetupStateBlock [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $TriSetupStateBlock eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.StateBitsCount {192} \
 ] $TriSetupStateBlock
  ...
  # Create instance: TriWorkCache2_0, and set properties
  set block_name TriWorkCache2
  set block_cell_name TriWorkCache2_0
  if { [catch {set TriWorkCache2_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $TriWorkCache2_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.Full_Threshold_Assert_Value {511} \
   CONFIG.Full_Threshold_Negate_Value {510} \
   CONFIG.Input_Data_Width {272} \
   CONFIG.Input_Depth {512} \
   CONFIG.Output_Data_Width {272} \
   CONFIG.Output_Depth {512} \
   CONFIG.Performance_Options {First_Word_Fall_Through} \
   CONFIG.Read_Data_Count_Width {9} \
   CONFIG.Use_Embedded_Registers {false} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE57_TYPE {1} \
   CONFIG.C_PROBE57_WIDTH {294} \
   CONFIG.C_PROBE58_WIDTH {77} \
   CONFIG.C_PROBE59_WIDTH {32} \
   CONFIG.C_PROBE5_TYPE {0} \
  ...
  # Create instance: ila_states, and set properties
  set ila_states [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_states ]
  set_property -dict [ list \
   CONFIG.C_ENABLE_ILA_AXI_MON {false} \
   CONFIG.C_MONITOR_TYPE {Native} \
   CONFIG.C_NUM_OF_PROBES {23} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AttrInterpolator_0_ATTR_FIFO [get_bd_intf_pins ATTR_FIFO/FIFO_READ] [get_bd_intf_pins AttrInterpolator_0/ATTR_FIFO]
  ...
  connect_bd_intf_net -intf_net CommandProcessor_0_returnPacketsFIFO [get_bd_intf_pins CommandProcessor_0/returnPacketsFIFO] [get_bd_intf_pins NetworkPacketSystem/FIFO_WRITE]
  connect_bd_intf_net -intf_net CommandProcessor_0_validPacketsFIFO [get_bd_intf_pins CommandProcessor_0/validPacketsFIFO] [get_bd_intf_pins NetworkPacketSystem/FIFO_READ]
  ...
  connect_bd_intf_net -intf_net DepthInterpolator_0_ATTR_FIFO [get_bd_intf_pins ATTR_FIFO/FIFO_WRITE] [get_bd_intf_pins DepthInterpolator_0/ATTR_FIFO]
  ...
  connect_bd_intf_net -intf_net NetworkPacketSystem_ext_mdio_pcs_pma_0_0 [get_bd_intf_ports ext_mdio_pcs_pma_0_0] [get_bd_intf_pins NetworkPacketSystem/mdio_mdc]
  connect_bd_intf_net -intf_net NetworkPacketSystem_sgmii_0_0 [get_bd_intf_ports sgmii_0_0] [get_bd_intf_pins NetworkPacketSystem/sgmii_lvds]
  ...
  connect_bd_intf_net -intf_net StatsCollector_0_StatsWriteOrderNibblesFIFO_RD [get_bd_intf_pins StatsCollector_0/StatsWriteOrderNibblesFIFO_RD] [get_bd_intf_pins StatsWriteOrderNibblesFIFO/FIFO_READ]
  connect_bd_intf_net -intf_net StatsCollector_0_StatsWriteOrderNibblesFIFO_WR [get_bd_intf_pins StatsCollector_0/StatsWriteOrderNibblesFIFO_WR] [get_bd_intf_pins StatsWriteOrderNibblesFIFO/FIFO_WRITE]
  ...
  connect_bd_intf_net -intf_net TexFetchReadResponsesFIFO_1 [get_bd_intf_pins MemorySystem/TexFetchReadResponsesFIFO] [get_bd_intf_pins TexSample_0/TexSampReadResponses]
  ...
  connect_bd_intf_net -intf_net TriWorkCache2_0_DINTERP_TRIDATA_RD [get_bd_intf_pins DINTERP_TRIDATA_FIFO/FIFO_READ] [get_bd_intf_pins TriWorkCache2_0/DINTERP_TRIDATA_RD]
  connect_bd_intf_net -intf_net TriWorkCache2_0_DINTERP_TRIDATA_WR [get_bd_intf_pins DINTERP_TRIDATA_FIFO/FIFO_WRITE] [get_bd_intf_pins TriWorkCache2_0/DINTERP_TRIDATA_WR]
  connect_bd_intf_net -intf_net TriWorkCache2_0_INTERP_TRIDATA_RD [get_bd_intf_pins ATTRINTERP_TRIDATA_FIFO/FIFO_READ] [get_bd_intf_pins TriWorkCache2_0/INTERP_TRIDATA_RD]
  connect_bd_intf_net -intf_net TriWorkCache2_0_INTERP_TRIDATA_WR [get_bd_intf_pins ATTRINTERP_TRIDATA_FIFO/FIFO_WRITE] [get_bd_intf_pins TriWorkCache2_0/INTERP_TRIDATA_WR]
  ...
  connect_bd_intf_net -intf_net refclk625_in_0_1 [get_bd_intf_ports sgmii_phyclk] [get_bd_intf_pins NetworkPacketSystem/refclk625_in_0]
  ...
  connect_bd_net -net ATTR_FIFO_prog_full [get_bd_pins ATTR_FIFO/prog_full] [get_bd_pins DepthInterpolator_0/ATTR_FIFO_almost_full]
  ...
  connect_bd_net -net AttrInterpolator_0_DBG_AttrInterpolator_State [get_bd_pins AttrInterpolator_0/DBG_AttrInterpolator_State] [get_bd_pins ILA_AttrInterpolator/probe2] [get_bd_pins ila_333_250/probe7] [get_bd_pins ila_states/probe10]
  ...
  connect_bd_net -net AttrInterpolator_0_STATE_ConsumeStateSlot [get_bd_pins AttrInterpStateBlock/STAGE_ConsumeStateSlot] [get_bd_pins AttrInterpolator_0/STATE_ConsumeStateSlot]
  connect_bd_net -net AttrInterpolator_0_STAT_CurrentDrawEventID [get_bd_pins AttrInterpolator_0/STAT_CurrentDrawEventID] [get_bd_pins ILA_TexSampler/probe15] [get_bd_pins StatsCollector_0/INTERP_CurrentDrawEventID] [get_bd_pins ila_states/probe20]
  ...
  connect_bd_net -net AttrInterpolator_0_TRICACHE_PopTriangleSlot [get_bd_pins AttrInterpolator_0/TRICACHE_PopTriangleSlot] [get_bd_pins TriWorkCache2_0/INTERP_PopTriangleSlot]
  ...
  connect_bd_net -net ClipUnit_0_DBG_CurrentState [get_bd_pins ClipUnit_0/DBG_CurrentState] [get_bd_pins ILA_TriSetup/probe47] [get_bd_pins ila_states/probe6]
  ...
  connect_bd_net -net ClipUnit_0_STATE_ConsumeStateSlot [get_bd_pins ClipUnitStateBlock/STAGE_ConsumeStateSlot] [get_bd_pins ClipUnit_0/STATE_ConsumeStateSlot]
  connect_bd_net -net ClipUnit_0_STAT_CurrentDrawEventID [get_bd_pins ClipUnit_0/STAT_CurrentDrawEventID] [get_bd_pins ILA_TexSampler/probe19] [get_bd_pins StatsCollector_0/CLIP_CurrentDrawEventID] [get_bd_pins ila_states/probe16]
  ...
  connect_bd_net -net ClipUnit_0_TRISETUP_CurrentDrawEventID [get_bd_pins ClipUnit_0/TRISETUP_CurrentDrawEventID] [get_bd_pins TriSetup_0/CLIP_CurrentDrawEventID]
  ...
  connect_bd_net -net CommandProcessor_0_CLIP_EndFrameReset [get_bd_pins ClipUnitStateBlock/CMD_EndFrameReset] [get_bd_pins CommandProcessor_0/CLIP_EndFrameReset]
  connect_bd_net -net CommandProcessor_0_CLIP_NewStateBits [get_bd_pins ClipUnitStateBlock/CMD_NewStateBits] [get_bd_pins CommandProcessor_0/CLIP_NewStateBits]
  connect_bd_net -net CommandProcessor_0_CLIP_NewStateDrawEventID [get_bd_pins ClipUnitStateBlock/CMD_NewStateDrawEventID] [get_bd_pins CommandProcessor_0/CLIP_NewStateDrawEventID]
  connect_bd_net -net CommandProcessor_0_CLIP_SetNewState [get_bd_pins ClipUnitStateBlock/CMD_SetNewState] [get_bd_pins CommandProcessor_0/CLIP_SetNewState]
  connect_bd_net -net CommandProcessor_0_DBG_CurrentDrawGeneration [get_bd_pins CommandProcessor_0/DBG_CurrentDrawGeneration] [get_bd_pins ila_333_250/probe15] [get_bd_pins ila_states/probe2]
  connect_bd_net -net CommandProcessor_0_DBG_IdleSignalsVector [get_bd_pins CommandProcessor_0/DBG_IdleSignalsVector] [get_bd_pins ila_333_250/probe28] [get_bd_pins ila_states/probe1]
  ...
  connect_bd_net -net CommandProcessor_0_DBG_PACKETSTATE [get_bd_pins CommandProcessor_0/DBG_CMDPACKETSTATE] [get_bd_pins ila_333_250/probe0] [get_bd_pins ila_states/probe0]
  ...
  connect_bd_net -net CommandProcessor_0_DEPTH_ClearStencilBuffer [get_bd_pins CommandProcessor_0/DEPTH_ClearStencilBuffer] [get_bd_pins DepthBuffer_0/CMD_ClearStencilBuffer]
  connect_bd_net -net CommandProcessor_0_DEPTH_ClearStencilValue [get_bd_pins CommandProcessor_0/DEPTH_ClearStencilValue] [get_bd_pins DepthBuffer_0/CMD_ClearStencilValue]
  ...
  connect_bd_net -net CommandProcessor_0_IA_SetNewState [get_bd_pins CommandProcessor_0/IA_SetNewState] [get_bd_pins InputAssemblerStateBlock/CMD_SetNewState]
  connect_bd_net -net CommandProcessor_0_INTERP_EndFrameReset [get_bd_pins AttrInterpStateBlock/CMD_EndFrameReset] [get_bd_pins CommandProcessor_0/INTERP_EndFrameReset]
  connect_bd_net -net CommandProcessor_0_INTERP_NewStateBits [get_bd_pins AttrInterpStateBlock/CMD_NewStateBits] [get_bd_pins CommandProcessor_0/INTERP_NewStateBits]
  connect_bd_net -net CommandProcessor_0_INTERP_NewStateDrawEventID [get_bd_pins AttrInterpStateBlock/CMD_NewStateDrawEventID] [get_bd_pins CommandProcessor_0/INTERP_NewStateDrawEventID]
  connect_bd_net -net CommandProcessor_0_INTERP_SetNewState [get_bd_pins AttrInterpStateBlock/CMD_SetNewState] [get_bd_pins CommandProcessor_0/INTERP_SetNewState]
  ...
  connect_bd_net -net CommandProcessor_0_ROP_EndFrameReset [get_bd_pins CommandProcessor_0/ROP_EndFrameReset] [get_bd_pins ROPStateBlock/CMD_EndFrameReset]
  ...
  connect_bd_net -net CommandProcessor_0_ROP_NewStateBits [get_bd_pins CommandProcessor_0/ROP_NewStateBits] [get_bd_pins ROPStateBlock/CMD_NewStateBits]
  connect_bd_net -net CommandProcessor_0_ROP_NewStateDrawEventID [get_bd_pins CommandProcessor_0/ROP_NewStateDrawEventID] [get_bd_pins ROPStateBlock/CMD_NewStateDrawEventID]
  ...
  connect_bd_net -net CommandProcessor_0_ROP_SetNewState [get_bd_pins CommandProcessor_0/ROP_SetNewState] [get_bd_pins ROPStateBlock/CMD_SetNewState]
  ...
  connect_bd_net -net CommandProcessor_0_STAT_EnableEventTimestamps [get_bd_pins CommandProcessor_0/STAT_EnableEventTimestamps] [get_bd_pins StatsCollector_0/CMD_EnableEventTimestamps] [get_bd_pins ila_333_250/probe55]
  ...
  connect_bd_net -net CommandProcessor_0_STAT_SetNewStatsConfig [get_bd_pins CommandProcessor_0/STAT_SetNewStatsConfig] [get_bd_pins StatsCollector_0/CMD_SetNewStatsConfig]
  connect_bd_net -net CommandProcessor_0_STAT_WriteEventTimestampOrders [get_bd_pins CommandProcessor_0/STAT_WriteEventTimestampOrders] [get_bd_pins StatsCollector_0/CMD_WriteEventTimestampOrders]
  connect_bd_net -net CommandProcessor_0_STAT_WriteEventTimestampsAddress [get_bd_pins CommandProcessor_0/STAT_WriteEventTimestampsAddress] [get_bd_pins StatsCollector_0/CMD_WriteEventTimestampsAddress]
  ...
  connect_bd_net -net CommandProcessor_0_TEXSAMP_EndFrameReset [get_bd_pins CommandProcessor_0/TEXSAMP_EndFrameReset] [get_bd_pins TexSampleStateBlock/CMD_EndFrameReset]
  connect_bd_net -net CommandProcessor_0_TEXSAMP_NewStateBits [get_bd_pins CommandProcessor_0/TEXSAMP_NewStateBits] [get_bd_pins TexSampleStateBlock/CMD_NewStateBits]
  connect_bd_net -net CommandProcessor_0_TEXSAMP_NewStateDrawEventID [get_bd_pins CommandProcessor_0/TEXSAMP_NewStateDrawEventID] [get_bd_pins TexSampleStateBlock/CMD_NewStateDrawEventID]
  connect_bd_net -net CommandProcessor_0_TEXSAMP_SetNewState [get_bd_pins CommandProcessor_0/TEXSAMP_SetNewState] [get_bd_pins TexSampleStateBlock/CMD_SetNewState] [get_bd_pins ila_333_250/probe17]
  connect_bd_net -net CommandProcessor_0_TRISETUP_EndFrameReset [get_bd_pins CommandProcessor_0/TRISETUP_EndFrameReset] [get_bd_pins TriSetupStateBlock/CMD_EndFrameReset]
  connect_bd_net -net CommandProcessor_0_TRISETUP_NewStateBits [get_bd_pins CommandProcessor_0/TRISETUP_NewStateBits] [get_bd_pins TriSetupStateBlock/CMD_NewStateBits]
  connect_bd_net -net CommandProcessor_0_TRISETUP_NewStateDrawEventID [get_bd_pins CommandProcessor_0/TRISETUP_NewStateDrawEventID] [get_bd_pins TriSetupStateBlock/CMD_NewStateDrawEventID]
  connect_bd_net -net CommandProcessor_0_TRISETUP_SetNewState [get_bd_pins CommandProcessor_0/TRISETUP_SetNewState] [get_bd_pins TriSetupStateBlock/CMD_SetNewState]
  ...
  connect_bd_net -net DINTERP_FPU_CNV1_OCNV [get_bd_pins DINTERP_FPU_CNV1/OCNV] [get_bd_pins DepthInterpolator_0/FPU_CNV1_OUT]
  connect_bd_net -net DINTERP_FPU_CNV_OCNV [get_bd_pins DINTERP_FPU_CNV0/OCNV] [get_bd_pins DepthInterpolator_0/FPU_CNV0_OUT]
  connect_bd_net -net DepthBuffer_0_CMD_DepthIsIdle [get_bd_pins CommandProcessor_0/CMD_Depth_Idle] [get_bd_pins DepthBuffer_0/CMD_DepthIsIdle] [get_bd_pins ILA_AttrInterpolator/probe13]
  ...
  connect_bd_net -net DepthBuffer_0_RAST_PixelFailedStencilTest [get_bd_pins DepthBuffer_0/RAST_PixelFailedStencilTest] [get_bd_pins DepthInterpolator_0/DEPTH_PixelFailedStencilTest]
  connect_bd_net -net DepthBuffer_0_RAST_PixelPassedDepthStencilTest [get_bd_pins DepthBuffer_0/RAST_PixelPassedDepthStencilTest] [get_bd_pins DepthInterpolator_0/DEPTH_PixelPassedDepthStencilTest]
  connect_bd_net -net DepthBuffer_0_STAT_PixelsFailedDepthTest [get_bd_pins DepthBuffer_0/STAT_PixelsFailedDepthTest] [get_bd_pins ILA_AttrInterpolator/probe17]
  connect_bd_net -net DepthBuffer_0_STAT_PixelsFailedStencilTest [get_bd_pins DepthBuffer_0/STAT_PixelsFailedStencilTest] [get_bd_pins ILA_AttrInterpolator/probe18]
  connect_bd_net -net DepthBuffer_0_STAT_PixelsPassedDepthStencilTest [get_bd_pins DepthBuffer_0/STAT_PixelsPassedDepthStencilTest] [get_bd_pins ILA_AttrInterpolator/probe16]
  connect_bd_net -net DepthBuffer_0_URAM_addra [get_bd_pins DepthBuffer_0/URAM_addra] [get_bd_pins DepthBuffer_URAM/addra] [get_bd_pins ILA_AttrInterpolator/probe11]
  connect_bd_net -net DepthBuffer_0_URAM_addrb [get_bd_pins DepthBuffer_0/URAM_addrb] [get_bd_pins DepthBuffer_URAM/addrb] [get_bd_pins ILA_AttrInterpolator/probe10]
  connect_bd_net -net DepthBuffer_0_URAM_dina [get_bd_pins DepthBuffer_0/URAM_dina] [get_bd_pins DepthBuffer_URAM/dina] [get_bd_pins ILA_AttrInterpolator/probe8]
  connect_bd_net -net DepthBuffer_0_URAM_wea [get_bd_pins DepthBuffer_0/URAM_wea] [get_bd_pins DepthBuffer_URAM/wea] [get_bd_pins ILA_AttrInterpolator/probe9]
  ...
  connect_bd_net -net DepthInterpolator_0_DBG_CurrentDepthStencilState [get_bd_pins DepthInterpolator_0/DBG_CurrentDepthStencilState] [get_bd_pins ila_333_250/probe58]
  connect_bd_net -net DepthInterpolator_0_DBG_DepthInterpolator_State [get_bd_pins DepthInterpolator_0/DBG_DepthInterpolator_State] [get_bd_pins ILA_AttrInterpolator/probe12] [get_bd_pins ila_states/probe9]
  ...
  connect_bd_net -net DepthInterpolator_0_DEPTH_OutPixelDepth [get_bd_pins DepthBuffer_0/RAST_InPixelDepth] [get_bd_pins DepthInterpolator_0/DEPTH_OutPixelDepth] [get_bd_pins ILA_AttrInterpolator/probe1]
  connect_bd_net -net DepthInterpolator_0_DEPTH_PixelReady [get_bd_pins DepthBuffer_0/RAST_PixelReady] [get_bd_pins DepthInterpolator_0/DEPTH_PixelReady] [get_bd_pins ILA_AttrInterpolator/probe14]
  ...
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilCmpFunc [get_bd_pins DepthBuffer_0/RAST_StencilCmpFunc] [get_bd_pins DepthInterpolator_0/DEPTH_StencilCmpFunc]
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilFailOp [get_bd_pins DepthBuffer_0/RAST_StencilFailOp] [get_bd_pins DepthInterpolator_0/DEPTH_StencilFailOp]
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilPassOp [get_bd_pins DepthBuffer_0/RAST_StencilPassOp] [get_bd_pins DepthInterpolator_0/DEPTH_StencilPassOp]
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilReadMask [get_bd_pins DepthBuffer_0/RAST_StencilReadMask] [get_bd_pins DepthInterpolator_0/DEPTH_StencilReadMask]
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilRefVal [get_bd_pins DepthBuffer_0/RAST_StencilRefVal] [get_bd_pins DepthInterpolator_0/DEPTH_StencilRefVal]
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilWriteEnable [get_bd_pins DepthBuffer_0/RAST_StencilWriteEnable] [get_bd_pins DepthInterpolator_0/DEPTH_StencilWriteEnable]
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilWriteMask [get_bd_pins DepthBuffer_0/RAST_StencilWriteMask] [get_bd_pins DepthInterpolator_0/DEPTH_StencilWriteMask]
  connect_bd_net -net DepthInterpolator_0_DEPTH_StencilZFailOp [get_bd_pins DepthBuffer_0/RAST_StencilZFailOp] [get_bd_pins DepthInterpolator_0/DEPTH_StencilZFailOp]
  connect_bd_net -net DepthInterpolator_0_FPU_CNV0_A [get_bd_pins DINTERP_FPU_CNV0/IN_A] [get_bd_pins DepthInterpolator_0/FPU_CNV0_A]
  connect_bd_net -net DepthInterpolator_0_FPU_CNV0_GO [get_bd_pins DINTERP_FPU_CNV0/ICNV_GO] [get_bd_pins DepthInterpolator_0/FPU_CNV0_GO]
  connect_bd_net -net DepthInterpolator_0_FPU_CNV0_Mode [get_bd_pins DINTERP_FPU_CNV0/IN_MODE] [get_bd_pins DepthInterpolator_0/FPU_CNV0_Mode]
  connect_bd_net -net DepthInterpolator_0_FPU_CNV1_A [get_bd_pins DINTERP_FPU_CNV1/IN_A] [get_bd_pins DepthInterpolator_0/FPU_CNV1_A]
  connect_bd_net -net DepthInterpolator_0_FPU_CNV1_GO [get_bd_pins DINTERP_FPU_CNV1/ICNV_GO] [get_bd_pins DepthInterpolator_0/FPU_CNV1_GO]
  connect_bd_net -net DepthInterpolator_0_FPU_CNV1_Mode [get_bd_pins DINTERP_FPU_CNV1/IN_MODE] [get_bd_pins DepthInterpolator_0/FPU_CNV1_Mode]
  connect_bd_net -net DepthInterpolator_0_FPU_MUL_A [get_bd_pins DINTERP_FPU_MUL/IN_A] [get_bd_pins DepthInterpolator_0/FPU_MUL_A]
  connect_bd_net -net DepthInterpolator_0_FPU_MUL_B [get_bd_pins DINTERP_FPU_MUL/IN_B] [get_bd_pins DepthInterpolator_0/FPU_MUL_B]
  connect_bd_net -net DepthInterpolator_0_FPU_MUL_GO [get_bd_pins DINTERP_FPU_MUL/IMUL_GO] [get_bd_pins DepthInterpolator_0/FPU_MUL_GO]
  connect_bd_net -net DepthInterpolator_0_FPU_SPEC_A [get_bd_pins DINTERP_FPU_SPEC/IN_A] [get_bd_pins DepthInterpolator_0/FPU_SPEC_A]
  connect_bd_net -net DepthInterpolator_0_FPU_SPEC_GO [get_bd_pins DINTERP_FPU_SPEC/ISPEC_GO] [get_bd_pins DepthInterpolator_0/FPU_SPEC_GO]
  ...
  connect_bd_net -net DepthInterpolator_0_STAT_CurrentDrawEventID [get_bd_pins DepthInterpolator_0/STAT_CurrentDrawEventID] [get_bd_pins ILA_TexSampler/probe16] [get_bd_pins StatsCollector_0/DINTERP_CurrentDrawEventID] [get_bd_pins ila_states/probe19]
  ...
  connect_bd_net -net DepthInterpolator_0_STAT_DepthOnlyPixelsPassed [get_bd_pins CommandProcessor_0/DINTERP_STAT_CountDepthOnlyPixelsPassed] [get_bd_pins DepthInterpolator_0/STAT_DepthOnlyPixelsPassed]
  connect_bd_net -net DepthInterpolator_0_TRICACHE_PopTriangleSlot [get_bd_pins DepthInterpolator_0/TRICACHE_PopTriangleSlot] [get_bd_pins TriWorkCache2_0/DINTERP_PopTriangleSlot]
  ...
  connect_bd_net -net InputAssembler2_0_CLIP_CurrentDrawEventID [get_bd_pins ClipUnit_0/IA_CurrentDrawEventID] [get_bd_pins InputAssembler2_0/CLIP_CurrentDrawEventID] [get_bd_pins StatsCollector_0/IA_CurrentDrawEventID]
  ...
  connect_bd_net -net InputAssembler2_0_DBG_IA_State [get_bd_pins ILA_TriSetup/probe42] [get_bd_pins InputAssembler2_0/DBG_IA_State] [get_bd_pins ila_states/probe5]
  ...
  connect_bd_net -net InputAssembler2_0_STATE_ConsumeStateSlot [get_bd_pins InputAssembler2_0/STATE_ConsumeStateSlot] [get_bd_pins InputAssemblerStateBlock/STAGE_ConsumeStateSlot]
  connect_bd_net -net InputAssembler2_0_STAT_CurrentDrawEventID [get_bd_pins ILA_TexSampler/probe20] [get_bd_pins InputAssembler2_0/STAT_CurrentDrawEventID] [get_bd_pins ila_states/probe15]
  ...
  connect_bd_net -net InputAssembler2_0_VERTOUT_FIFO_rd_en [get_bd_pins InputAssembler2_0/VERTOUT_FIFO_rd_en] [get_bd_pins VBO_FIFO/rd_en]
  connect_bd_net -net InputAssemblerStateBlock_CMD_NumFreeSlots [get_bd_pins CommandProcessor_0/IA_NumFreeSlots] [get_bd_pins InputAssemblerStateBlock/CMD_NumFreeSlots]
  connect_bd_net -net InputAssemblerStateBlock_STAGE_NextDrawID [get_bd_pins InputAssembler2_0/STATE_NextDrawID] [get_bd_pins InputAssemblerStateBlock/STAGE_NextDrawID]
  connect_bd_net -net InputAssemblerStateBlock_STAGE_StateBitsAtDrawID [get_bd_pins InputAssembler2_0/STATE_StateBitsAtDrawID] [get_bd_pins InputAssemblerStateBlock/STAGE_StateBitsAtDrawID]
  connect_bd_net -net InputAssemblerStateBlock_STAGE_StateIsValid [get_bd_pins InputAssembler2_0/STATE_StateIsValid] [get_bd_pins InputAssemblerStateBlock/STAGE_StateIsValid]
  ...
  connect_bd_net -net Net [get_bd_pins DepthBuffer_0/URAM_doutb] [get_bd_pins DepthBuffer_URAM/doutb] [get_bd_pins ILA_AttrInterpolator/probe7]
  connect_bd_net -net ROPStateBlock_CMD_NumFreeSlots [get_bd_pins CommandProcessor_0/ROP_NumFreeSlots] [get_bd_pins ROPStateBlock/CMD_NumFreeSlots]
  connect_bd_net -net ROPStateBlock_STAGE_NextDrawID [get_bd_pins ROPStateBlock/STAGE_NextDrawID] [get_bd_pins ROP_0/STATE_NextDrawID]
  connect_bd_net -net ROPStateBlock_STAGE_StateBitsAtDrawID [get_bd_pins ROPStateBlock/STAGE_StateBitsAtDrawID] [get_bd_pins ROP_0/STATE_StateBitsAtDrawID]
  connect_bd_net -net ROPStateBlock_STAGE_StateIsValid [get_bd_pins ROPStateBlock/STAGE_StateIsValid] [get_bd_pins ROP_0/STATE_StateIsValid]
  ...
  connect_bd_net -net ROP_0_DBG_ROP_State [get_bd_pins ROP_0/DBG_ROP_State] [get_bd_pins ila_333_250/probe9] [get_bd_pins ila_states/probe12]
  ...
  connect_bd_net -net ROP_0_STATE_ConsumeStateSlot [get_bd_pins ROPStateBlock/STAGE_ConsumeStateSlot] [get_bd_pins ROP_0/STATE_ConsumeStateSlot]
  ...
  connect_bd_net -net ROP_0_STAT_CountPixelsPassed [get_bd_pins CommandProcessor_0/ROP_STAT_CountPixelsPassed] [get_bd_pins ROP_0/STAT_CountPixelsPassed] [get_bd_pins ila_333_250/probe59]
  connect_bd_net -net ROP_0_STAT_CurrentDrawEventID [get_bd_pins CommandProcessor_0/ROP_STAT_CurrentDrawEventID] [get_bd_pins ILA_TexSampler/probe14] [get_bd_pins ROP_0/STAT_CurrentDrawEventID] [get_bd_pins StatsCollector_0/ROP_CurrentDrawEventID] [get_bd_pins ila_333_250/probe12] [get_bd_pins ila_states/probe22]
  ...
  connect_bd_net -net ROP_0_TEXSAMP_InFIFO_rd_en [get_bd_pins ROP_0/TEXSAMP_InFIFO_rd_en] [get_bd_pins ROP_FIFO/rd_en]
  connect_bd_net -net ROP_FIFO_dout [get_bd_pins ROP_0/TEXSAMP_InFIFO_rd_data] [get_bd_pins ROP_FIFO/dout]
  connect_bd_net -net ROP_FIFO_empty [get_bd_pins CommandProcessor_0/CMD_FIFO_EMPTY_ROP] [get_bd_pins ROP_0/TEXSAMP_InFIFO_empty] [get_bd_pins ROP_FIFO/empty]
  ...
  connect_bd_net -net Rasterizer_0_DBG_Rasterizer_State [get_bd_pins Rasterizer_0/DBG_Rasterizer_State] [get_bd_pins ila_333_250/probe6] [get_bd_pins ila_states/probe8]
  connect_bd_net -net Rasterizer_0_STAT_CurrentDrawEventID [get_bd_pins ILA_TexSampler/probe17] [get_bd_pins Rasterizer_0/STAT_CurrentDrawEventID] [get_bd_pins StatsCollector_0/RAST_CurrentDrawEventID] [get_bd_pins ila_states/probe18]
  ...
  connect_bd_net -net Rasterizer_0_TRICACHE_BarycentricInverse [get_bd_pins Rasterizer_0/TRICACHE_BarycentricInverse] [get_bd_pins TriWorkCache2_0/RAST_inBarycentricInverse]
  connect_bd_net -net Rasterizer_0_TRICACHE_InvW0 [get_bd_pins Rasterizer_0/TRICACHE_InvW0] [get_bd_pins TriWorkCache2_0/RAST_inInvW0]
  connect_bd_net -net Rasterizer_0_TRICACHE_InvW10 [get_bd_pins Rasterizer_0/TRICACHE_InvW10] [get_bd_pins TriWorkCache2_0/RAST_inInvW10]
  connect_bd_net -net Rasterizer_0_TRICACHE_InvW20 [get_bd_pins Rasterizer_0/TRICACHE_InvW20] [get_bd_pins TriWorkCache2_0/RAST_inInvW20]
  connect_bd_net -net Rasterizer_0_TRICACHE_PushNewTriData [get_bd_pins Rasterizer_0/TRICACHE_PushNewTriData] [get_bd_pins TriWorkCache2_0/RAST_PushNewTriData]
  connect_bd_net -net Rasterizer_0_TRICACHE_TX0 [get_bd_pins Rasterizer_0/TRICACHE_TX0] [get_bd_pins TriWorkCache2_0/RAST_inT0X]
  connect_bd_net -net Rasterizer_0_TRICACHE_TX10 [get_bd_pins Rasterizer_0/TRICACHE_TX10] [get_bd_pins TriWorkCache2_0/RAST_inT10X]
  connect_bd_net -net Rasterizer_0_TRICACHE_TX20 [get_bd_pins Rasterizer_0/TRICACHE_TX20] [get_bd_pins TriWorkCache2_0/RAST_inT20X]
  connect_bd_net -net Rasterizer_0_TRICACHE_TY0 [get_bd_pins Rasterizer_0/TRICACHE_TY0] [get_bd_pins TriWorkCache2_0/RAST_inT0Y]
  connect_bd_net -net Rasterizer_0_TRICACHE_TY10 [get_bd_pins Rasterizer_0/TRICACHE_TY10] [get_bd_pins TriWorkCache2_0/RAST_inT10Y]
  connect_bd_net -net Rasterizer_0_TRICACHE_TY20 [get_bd_pins Rasterizer_0/TRICACHE_TY20] [get_bd_pins TriWorkCache2_0/RAST_inT20Y]
  connect_bd_net -net Rasterizer_0_TRICACHE_VertColor0 [get_bd_pins Rasterizer_0/TRICACHE_VertColor0] [get_bd_pins TriWorkCache2_0/RAST_inColorRGBA0]
  connect_bd_net -net Rasterizer_0_TRICACHE_VertColor10 [get_bd_pins Rasterizer_0/TRICACHE_VertColor10] [get_bd_pins TriWorkCache2_0/RAST_inColorRGBA10]
  connect_bd_net -net Rasterizer_0_TRICACHE_VertColor20 [get_bd_pins Rasterizer_0/TRICACHE_VertColor20] [get_bd_pins TriWorkCache2_0/RAST_inColorRGBA20]
  connect_bd_net -net Rasterizer_0_TRICACHE_Z0 [get_bd_pins Rasterizer_0/TRICACHE_Z0] [get_bd_pins TriWorkCache2_0/RAST_inZ0]
  connect_bd_net -net Rasterizer_0_TRICACHE_Z10 [get_bd_pins Rasterizer_0/TRICACHE_Z10] [get_bd_pins TriWorkCache2_0/RAST_inZ10]
  connect_bd_net -net Rasterizer_0_TRICACHE_Z20 [get_bd_pins Rasterizer_0/TRICACHE_Z20] [get_bd_pins TriWorkCache2_0/RAST_inZ20]
  ...
  connect_bd_net -net ResetN_UntilClockLoc_0_resetn [get_bd_pins CommandProcessor_0/resetn] [get_bd_pins MemorySystem/M_AXI_ARESETN] [get_bd_pins ResetN_UntilClockLoc_0/resetn]
  ...
  connect_bd_net -net ShaderCoreSystem_CMD_IsIdle [get_bd_pins CommandProcessor_0/CMD_VS_Idle] [get_bd_pins ShaderCoreSystem/CMD_IsIdle]
  ...
  connect_bd_net -net ShaderCoreSystem_DBG_CurrentState [get_bd_pins ILA_IA/probe11] [get_bd_pins ShaderCoreSystem/DBG_CurrentState] [get_bd_pins ila_states/probe4]
  ...
  connect_bd_net -net ShaderCoreSystem_STAT_CurrentDrawEventID [get_bd_pins ILA_TexSampler/probe21] [get_bd_pins ShaderCoreSystem/STAT_CurrentDrawEventID] [get_bd_pins StatsCollector_0/VSHADER_CurrentDrawEventID] [get_bd_pins ila_states/probe14]
  ...
  connect_bd_net -net ShaderCoreSystem_VERTBATCH_FIFO_rd_en [get_bd_pins ShaderCoreSystem/VERTBATCH_FIFO_rd_en] [get_bd_pins VBB_FIFO/rd_en]
  ...
  connect_bd_net -net StandaloneFloatALU_M_0_OMUL2 [get_bd_pins AttrInterp_FPU_MUL/OMUL] [get_bd_pins AttrInterpolator_0/FPU_MUL_OUT]
  connect_bd_net -net StandaloneFloatALU_M_0_OMUL3 [get_bd_pins DINTERP_FPU_MUL/OMUL] [get_bd_pins DepthInterpolator_0/FPU_MUL_OUT]
  ...
  connect_bd_net -net StandaloneFloatALU_S_0_OSPEC2 [get_bd_pins DINTERP_FPU_SPEC/OSPEC] [get_bd_pins DepthInterpolator_0/FPU_SPEC_OUT]
  connect_bd_net -net StateBlock_0_CMD_NumFreeSlots [get_bd_pins CommandProcessor_0/TEXSAMP_NumFreeSlots] [get_bd_pins TexSampleStateBlock/CMD_NumFreeSlots] [get_bd_pins ila_333_250/probe16]
  connect_bd_net -net StateBlock_0_CMD_NumFreeSlots1 [get_bd_pins ClipUnitStateBlock/CMD_NumFreeSlots] [get_bd_pins CommandProcessor_0/CLIP_NumFreeSlots]
  connect_bd_net -net StateBlock_0_DBG_CurrentReadSlotIndex [get_bd_pins ILA_TexSampler/probe7] [get_bd_pins TexSampleStateBlock/DBG_CurrentReadSlotIndex]
  connect_bd_net -net StateBlock_0_DBG_CurrentWriteSlotIndex [get_bd_pins ILA_TexSampler/probe8] [get_bd_pins TexSampleStateBlock/DBG_CurrentWriteSlotIndex]
  connect_bd_net -net StateBlock_0_DBG_Slot0 [get_bd_pins ILA_TexSampler/probe10] [get_bd_pins TexSampleStateBlock/DBG_Slot0]
  connect_bd_net -net StateBlock_0_DBG_Slot1 [get_bd_pins ILA_TexSampler/probe11] [get_bd_pins TexSampleStateBlock/DBG_Slot1]
  connect_bd_net -net StateBlock_0_DBG_Slot2 [get_bd_pins ILA_TexSampler/probe12] [get_bd_pins TexSampleStateBlock/DBG_Slot2]
  connect_bd_net -net StateBlock_0_DBG_Slot3 [get_bd_pins ILA_TexSampler/probe13] [get_bd_pins TexSampleStateBlock/DBG_Slot3]
  connect_bd_net -net StateBlock_0_DBG_SlotsValid [get_bd_pins ILA_TexSampler/probe9] [get_bd_pins TexSampleStateBlock/DBG_SlotsValid]
  connect_bd_net -net StateBlock_0_STAGE_NextDrawID [get_bd_pins ILA_TexSampler/probe5] [get_bd_pins TexSampleStateBlock/STAGE_NextDrawID] [get_bd_pins TexSample_0/STATE_NextDrawID]
  connect_bd_net -net StateBlock_0_STAGE_NextDrawID1 [get_bd_pins ClipUnitStateBlock/STAGE_NextDrawID] [get_bd_pins ClipUnit_0/STATE_NextDrawID]
  connect_bd_net -net StateBlock_0_STAGE_StateBitsAtDrawID [get_bd_pins TexSampleStateBlock/STAGE_StateBitsAtDrawID] [get_bd_pins TexSample_0/STATE_StateBitsAtDrawID]
  connect_bd_net -net StateBlock_0_STAGE_StateBitsAtDrawID1 [get_bd_pins ClipUnitStateBlock/STAGE_StateBitsAtDrawID] [get_bd_pins ClipUnit_0/STATE_StateBitsAtDrawID]
  connect_bd_net -net StateBlock_0_STAGE_StateIsValid [get_bd_pins TexSampleStateBlock/STAGE_StateIsValid] [get_bd_pins TexSample_0/STATE_StateIsValid]
  connect_bd_net -net StateBlock_0_STAGE_StateIsValid1 [get_bd_pins ClipUnitStateBlock/STAGE_StateIsValid] [get_bd_pins ClipUnit_0/STATE_StateIsValid]
  connect_bd_net -net StateBlock_1_CMD_NumFreeSlots [get_bd_pins AttrInterpStateBlock/CMD_NumFreeSlots] [get_bd_pins CommandProcessor_0/INTERP_NumFreeSlots]
  connect_bd_net -net StateBlock_1_STAGE_NextDrawID [get_bd_pins AttrInterpStateBlock/STAGE_NextDrawID] [get_bd_pins AttrInterpolator_0/STATE_NextDrawID]
  connect_bd_net -net StateBlock_1_STAGE_StateBitsAtDrawID [get_bd_pins AttrInterpStateBlock/STAGE_StateBitsAtDrawID] [get_bd_pins AttrInterpolator_0/STATE_StateBitsAtDrawID]
  connect_bd_net -net StateBlock_1_STAGE_StateIsValid [get_bd_pins AttrInterpStateBlock/STAGE_StateIsValid] [get_bd_pins AttrInterpolator_0/STATE_StateIsValid]
  connect_bd_net -net StatsCollector_0_CMD_CountTimestampsMemoryWrites [get_bd_pins CommandProcessor_0/STAT_CountTimestampsMemoryWrites] [get_bd_pins StatsCollector_0/CMD_CountTimestampsMemoryWrites] [get_bd_pins ila_333_250/probe53]
  connect_bd_net -net StatsCollector_0_CMD_CountTimestampsOrdersMemoryWrites [get_bd_pins CommandProcessor_0/STAT_CountTimestampsOrdersMemoryWrites] [get_bd_pins StatsCollector_0/CMD_CountTimestampsOrdersMemoryWrites] [get_bd_pins ila_333_250/probe54]
  ...
  connect_bd_net -net StatsCollector_0_DBG_CurrentWriteData [get_bd_pins StatsCollector_0/DBG_CurrentWriteData] [get_bd_pins ila_333_250/probe57]
  connect_bd_net -net StatsCollector_0_DBG_CurrentWriteEn [get_bd_pins StatsCollector_0/DBG_CurrentWriteEn] [get_bd_pins ila_333_250/probe56]
  connect_bd_net -net StatsCollector_0_DBG_CurrentWriteOrderNibbles [get_bd_pins StatsCollector_0/DBG_CurrentWriteOrderNibbles] [get_bd_pins ila_333_250/probe52]
  connect_bd_net -net StatsCollector_0_DBG_EventsWriteIsReady [get_bd_pins StatsCollector_0/DBG_EventsWriteIsReady] [get_bd_pins ila_333_250/probe46]
  connect_bd_net -net StatsCollector_0_DBG_EventsWriteIsReadyAck [get_bd_pins StatsCollector_0/DBG_EventsWriteIsReadyAck] [get_bd_pins ila_333_250/probe47]
  connect_bd_net -net StatsCollector_0_STAT_ResetWriteOrderNibblesFIFO [get_bd_pins StatsCollector_0/STAT_ResetWriteOrderNibblesFIFO] [get_bd_pins StatsWriteOrderNibblesFIFO/srst]
  connect_bd_net -net StatsCollector_0_STAT_WriteOrderNibblesFIFO_rd_en [get_bd_pins StatsCollector_0/STAT_WriteOrderNibblesFIFO_rd_en] [get_bd_pins StatsWriteOrderNibblesFIFO/rd_en]
  connect_bd_net -net StatsCollector_0_STAT_WriteOrderNibblesFIFO_wr_data [get_bd_pins StatsCollector_0/STAT_WriteOrderNibblesFIFO_wr_data] [get_bd_pins StatsWriteOrderNibblesFIFO/din] [get_bd_pins ila_333_250/probe51]
  connect_bd_net -net StatsCollector_0_STAT_WriteOrderNibblesFIFO_wr_en [get_bd_pins StatsCollector_0/STAT_WriteOrderNibblesFIFO_wr_en] [get_bd_pins StatsWriteOrderNibblesFIFO/wr_en]
  connect_bd_net -net StatsWriteOrderNibblesFIFO_dout [get_bd_pins StatsCollector_0/STAT_WriteOrderNibblesFIFO_rd_data] [get_bd_pins StatsWriteOrderNibblesFIFO/dout] [get_bd_pins ila_333_250/probe50]
  connect_bd_net -net StatsWriteOrderNibblesFIFO_empty [get_bd_pins StatsCollector_0/STAT_WriteOrderNibblesFIFO_empty] [get_bd_pins StatsWriteOrderNibblesFIFO/empty] [get_bd_pins ila_333_250/probe48]
  ...
  connect_bd_net -net TexSample_0_DBG_TexSample_State [get_bd_pins ILA_TexSampler/probe0] [get_bd_pins TexSample_0/DBG_TexSample_State] [get_bd_pins ila_333_250/probe8] [get_bd_pins ila_states/probe11]
  ...
  connect_bd_net -net TexSample_0_STATE_ConsumeStateSlot [get_bd_pins ILA_TexSampler/probe6] [get_bd_pins TexSampleStateBlock/STAGE_ConsumeStateSlot] [get_bd_pins TexSample_0/STATE_ConsumeStateSlot]
  connect_bd_net -net TexSample_0_STAT_CurrentDrawEventID [get_bd_pins ILA_TexSampler/probe4] [get_bd_pins StatsCollector_0/TEXSAMP_CurrentDrawEventID] [get_bd_pins TexSample_0/STAT_CurrentDrawEventID] [get_bd_pins ila_states/probe21]
  ...
  connect_bd_net -net TriSetupStateBlock_CMD_NumFreeSlots [get_bd_pins CommandProcessor_0/TRISETUP_NumFreeSlots] [get_bd_pins TriSetupStateBlock/CMD_NumFreeSlots]
  connect_bd_net -net TriSetupStateBlock_STAGE_NextDrawID [get_bd_pins TriSetupStateBlock/STAGE_NextDrawID] [get_bd_pins TriSetup_0/STATE_NextDrawID]
  connect_bd_net -net TriSetupStateBlock_STAGE_StateBitsAtDrawID [get_bd_pins TriSetupStateBlock/STAGE_StateBitsAtDrawID] [get_bd_pins TriSetup_0/STATE_StateBitsAtDrawID]
  connect_bd_net -net TriSetupStateBlock_STAGE_StateIsValid [get_bd_pins TriSetupStateBlock/STAGE_StateIsValid] [get_bd_pins TriSetup_0/STATE_StateIsValid]
  ...
  connect_bd_net -net TriSetup_0_DBG_TriSetup_State [get_bd_pins ILA_TriSetup/probe30] [get_bd_pins TriSetup_0/DBG_TriSetup_State] [get_bd_pins ila_333_250/probe5] [get_bd_pins ila_states/probe7]
  ...
  connect_bd_net -net TriSetup_0_RAST_CurrentDrawEventID [get_bd_pins Rasterizer_0/TRISETUP_CurrentDrawEventID] [get_bd_pins TriSetup_0/RAST_CurrentDrawEventID]
  ...
  connect_bd_net -net TriSetup_0_STATE_ConsumeStateSlot [get_bd_pins TriSetupStateBlock/STAGE_ConsumeStateSlot] [get_bd_pins TriSetup_0/STATE_ConsumeStateSlot]
  connect_bd_net -net TriSetup_0_STAT_CurrentDrawEventID [get_bd_pins ILA_TexSampler/probe18] [get_bd_pins StatsCollector_0/TRISETUP_CurrentDrawEventID] [get_bd_pins TriSetup_0/STAT_CurrentDrawEventID] [get_bd_pins ila_states/probe17]
  ...
  connect_bd_net -net TriWorkCache2_0_DINTERP_outBarycentricInverse [get_bd_pins DepthInterpolator_0/TRICACHE_inBarycentricInverse] [get_bd_pins TriWorkCache2_0/DINTERP_outBarycentricInverse]
  connect_bd_net -net TriWorkCache2_0_DINTERP_outInvW0 [get_bd_pins DepthInterpolator_0/TRICACHE_inInvW0] [get_bd_pins TriWorkCache2_0/DINTERP_outInvW0]
  connect_bd_net -net TriWorkCache2_0_DINTERP_outInvW10 [get_bd_pins DepthInterpolator_0/TRICACHE_inInvW10] [get_bd_pins TriWorkCache2_0/DINTERP_outInvW10]
  connect_bd_net -net TriWorkCache2_0_DINTERP_outInvW20 [get_bd_pins DepthInterpolator_0/TRICACHE_inInvW20] [get_bd_pins TriWorkCache2_0/DINTERP_outInvW20]
  connect_bd_net -net TriWorkCache2_0_DINTERP_outZ0 [get_bd_pins DepthInterpolator_0/TRICACHE_inZ0] [get_bd_pins TriWorkCache2_0/DINTERP_outZ0]
  connect_bd_net -net TriWorkCache2_0_DINTERP_outZ10 [get_bd_pins DepthInterpolator_0/TRICACHE_inZ10] [get_bd_pins TriWorkCache2_0/DINTERP_outZ10]
  connect_bd_net -net TriWorkCache2_0_DINTERP_outZ20 [get_bd_pins DepthInterpolator_0/TRICACHE_inZ20] [get_bd_pins TriWorkCache2_0/DINTERP_outZ20]
  connect_bd_net -net TriWorkCache2_0_INTERP_outColorRGBA0 [get_bd_pins AttrInterpolator_0/TRICACHE_inColorRGBA0] [get_bd_pins TriWorkCache2_0/INTERP_outColorRGBA0]
  connect_bd_net -net TriWorkCache2_0_INTERP_outColorRGBA10 [get_bd_pins AttrInterpolator_0/TRICACHE_inColorRGBA10] [get_bd_pins TriWorkCache2_0/INTERP_outColorRGBA10]
  connect_bd_net -net TriWorkCache2_0_INTERP_outColorRGBA20 [get_bd_pins AttrInterpolator_0/TRICACHE_inColorRGBA20] [get_bd_pins TriWorkCache2_0/INTERP_outColorRGBA20]
  connect_bd_net -net TriWorkCache2_0_INTERP_outT0X [get_bd_pins AttrInterpolator_0/TRICACHE_inT0X] [get_bd_pins TriWorkCache2_0/INTERP_outT0X]
  connect_bd_net -net TriWorkCache2_0_INTERP_outT0Y [get_bd_pins AttrInterpolator_0/TRICACHE_inT0Y] [get_bd_pins TriWorkCache2_0/INTERP_outT0Y]
  connect_bd_net -net TriWorkCache2_0_INTERP_outT10X [get_bd_pins AttrInterpolator_0/TRICACHE_inT10X] [get_bd_pins TriWorkCache2_0/INTERP_outT10X]
  connect_bd_net -net TriWorkCache2_0_INTERP_outT10Y [get_bd_pins AttrInterpolator_0/TRICACHE_inT10Y] [get_bd_pins TriWorkCache2_0/INTERP_outT10Y]
  connect_bd_net -net TriWorkCache2_0_INTERP_outT20X [get_bd_pins AttrInterpolator_0/TRICACHE_inT20X] [get_bd_pins TriWorkCache2_0/INTERP_outT20X]
  connect_bd_net -net TriWorkCache2_0_INTERP_outT20Y [get_bd_pins AttrInterpolator_0/TRICACHE_inT20Y] [get_bd_pins TriWorkCache2_0/INTERP_outT20Y]
  connect_bd_net -net TriWorkCache2_0_RAST_IsFull [get_bd_pins Rasterizer_0/TRICACHE_IsFull] [get_bd_pins TriWorkCache2_0/RAST_IsFull]
  ...
  connect_bd_net -net VertexBatchBuilder_0_DBG_CurrentState [get_bd_pins ILA_IA/probe12] [get_bd_pins VertexBatchBuilder_0/DBG_CurrentState] [get_bd_pins ila_states/probe3]
  ...
  connect_bd_net -net VertexBatchBuilder_0_STAT_CurrentDrawEventID [get_bd_pins ILA_TexSampler/probe22] [get_bd_pins StatsCollector_0/VBB_CurrentDrawEventID] [get_bd_pins VertexBatchBuilder_0/STAT_CurrentDrawEventID] [get_bd_pins ila_states/probe13]
  ...
  connect_bd_net -net ddr4_0_addn_ui_clkout1 [get_bd_pins MemorySystem/addn_ui_clkout1] [get_bd_pins ScanoutSystem/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins ATTRINTERP_TRIDATA_FIFO/clk] [get_bd_pins ATTR_FIFO/clk] [get_bd_pins AttrInterpStateBlock/clk] [get_bd_pins AttrInterp_FPU_CNV0/clk] [get_bd_pins AttrInterp_FPU_CNV1/clk] [get_bd_pins AttrInterp_FPU_MUL/clk] [get_bd_pins AttrInterpolator_0/clk] [get_bd_pins CLIP_FPU_ADD_0/clk] [get_bd_pins CLIP_FPU_ADD_1/clk] [get_bd_pins CLIP_FPU_MUL_0/clk] [get_bd_pins CLIP_FPU_MUL_1/clk] [get_bd_pins CLIP_FPU_SPEC_0/clk] [get_bd_pins ClearBlock_0/clk] [get_bd_pins ClipUnitStateBlock/clk] [get_bd_pins ClipUnit_0/clk] [get_bd_pins CommandProcessor_0/clk] [get_bd_pins DINTERP_FPU_CNV0/clk] [get_bd_pins DINTERP_FPU_CNV1/clk] [get_bd_pins DINTERP_FPU_MUL/clk] [get_bd_pins DINTERP_FPU_SPEC/clk] [get_bd_pins DINTERP_TRIDATA_FIFO/clk] [get_bd_pins DepthBuffer_0/clk] [get_bd_pins DepthInterpStateBlock/clk] [get_bd_pins DepthInterpolator_0/clk] [get_bd_pins ILA_AttrInterpolator/clk] [get_bd_pins ILA_IA/clk] [get_bd_pins ILA_TexSampler/clk] [get_bd_pins ILA_TriSetup/clk] [get_bd_pins IndexBufferCache_0/clk] [get_bd_pins InputAssembler2_0/clk] [get_bd_pins InputAssemblerStateBlock/clk] [get_bd_pins MemorySystem/c0_ddr4_ui_clk] [get_bd_pins NetworkPacketSystem/clk333_250] [get_bd_pins ROPStateBlock/clk] [get_bd_pins ROP_0/clk] [get_bd_pins ROP_FIFO/clk] [get_bd_pins Rasterizer_0/clk] [get_bd_pins ScanoutSystem/cmd_clk] [get_bd_pins ShaderCoreSystem/clk_0] [get_bd_pins StatsCollector_0/clk] [get_bd_pins StatsWriteOrderNibblesFIFO/clk] [get_bd_pins TEXSAMP_FIFO/clk] [get_bd_pins TRISETUP_FPU_ADD/clk] [get_bd_pins TRISETUP_FPU_CNV/clk] [get_bd_pins TRISETUP_FPU_MUL/clk] [get_bd_pins TRISETUP_FPU_SPEC/clk] [get_bd_pins TexSampleStateBlock/clk] [get_bd_pins TexSample_0/clk] [get_bd_pins TextureCache_128x128x32bits/clka] [get_bd_pins TriSetupStateBlock/clk] [get_bd_pins TriSetup_0/clk] [get_bd_pins TriWorkCache2_0/clk] [get_bd_pins VBB_FIFO/clk] [get_bd_pins VBB_StateBlock/clk] [get_bd_pins VBO_FIFO/clk] [get_bd_pins VBO_INDEX_FIFO/clk] [get_bd_pins VertexBatchBuilder_0/clk] [get_bd_pins ila_333_250/clk] [get_bd_pins ila_states/clk] [get_bd_pins rast_out_fifo/clk]
  ...
  connect_bd_net -net rast_out_fifo_empty [get_bd_pins CommandProcessor_0/CMD_FIFO_EMPTY_RASTOUT] [get_bd_pins DepthInterpolator_0/RASTOUT_FIFO_empty] [get_bd_pins rast_out_fifo/empty]
  connect_bd_net -net rd_clk_1 [get_bd_pins MemorySystem/rd_clk] [get_bd_pins ScanoutSystem/clk_out1]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins MemorySystem/reset] [get_bd_pins ResetN_UntilClockLoc_0/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
