...
//               c:/Users/Tom/Documents/repos/FPGAGPUTesting/CPUDrivenGPUTest4/CPUDrivenGPUTest4.gen/sources_1/bd/MainDesign/ip/MainDesign_StateBlock_0_2/MainDesign_StateBlock_0_2_stub.v
...
(* CHECK_LICENSE_TYPE = "MainDesign_StateBlock_0_2,StateBlock,{}" *) (* core_generation_info = "MainDesign_StateBlock_0_2,StateBlock,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=StateBlock,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,StateBitsCount=11}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "module_ref" *) (* x_core_info = "StateBlock,Vivado 2025.2" *) 
module MainDesign_StateBlock_0_2(clk, CMD_SetNewState, CMD_EndFrameReset, 
  ...
  DBG_Slot3)
/* synthesis syn_black_box black_box_pad_pin="CMD_SetNewState,CMD_EndFrameReset,CMD_NumFreeSlots[2:0],CMD_NewStateBits[10:0],CMD_NewStateDrawEventID[15:0],STAGE_StateBitsAtDrawID[10:0],STAGE_NextDrawID[15:0],STAGE_StateIsValid,STAGE_ConsumeStateSlot,DBG_SlotsValid[3:0],DBG_CurrentReadSlotIndex[1:0],DBG_CurrentWriteSlotIndex[1:0],DBG_Slot0[15:0],DBG_Slot1[15:0],DBG_Slot2[15:0],DBG_Slot3[15:0]" */
