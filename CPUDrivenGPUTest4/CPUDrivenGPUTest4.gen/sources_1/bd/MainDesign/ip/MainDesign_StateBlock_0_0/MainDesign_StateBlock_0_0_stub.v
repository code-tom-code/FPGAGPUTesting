...
//               c:/Xilinx/MyXilinxProjects/CPUDrivenGPUTest4/CPUDrivenGPUTest4.gen/sources_1/bd/MainDesign/ip/MainDesign_StateBlock_0_0/MainDesign_StateBlock_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "MainDesign_StateBlock_0_0,StateBlock,{}" *) (* core_generation_info = "MainDesign_StateBlock_0_0,StateBlock,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=StateBlock,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,StateBitsCount=35}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "module_ref" *) (* x_core_info = "StateBlock,Vivado 2025.2" *) 
module MainDesign_StateBlock_0_0(clk, CMD_SetNewState, CMD_EndFrameReset, 
