...
-- Date        : Sun Dec 21 18:02:16 2025
-- Host        : TomTop3 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Tom/Documents/repos/FPGAGPUTesting/CPUDrivenGPUTest4/CPUDrivenGPUTest4.gen/sources_1/bd/MainDesign/ip/MainDesign_clk_wiz_0_1/MainDesign_clk_wiz_0_1_sim_netlist.vhdl
...
entity MainDesign_clk_wiz_0_1_clk_wiz is
  port (
    clk_out10_0 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end MainDesign_clk_wiz_0_1_clk_wiz;

architecture STRUCTURE of MainDesign_clk_wiz_0_1_clk_wiz is
  signal clk_in1_MainDesign_clk_wiz_0_1 : STD_LOGIC;
  signal clk_out10_0_MainDesign_clk_wiz_0_1 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_MainDesign_clk_wiz_0_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out10_0_MainDesign_clk_wiz_0_1,
      O => clk_out10_0
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1_PERIOD => 3.001000,
      CLKIN2_PERIOD => 0.000000,
      CLKOUT0_DIVIDE_F => 107.500000,
      ...
      CLKIN1 => clk_in1_MainDesign_clk_wiz_0_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out10_0_MainDesign_clk_wiz_0_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MainDesign_clk_wiz_0_1 is
  port (
    clk_out10_0 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of MainDesign_clk_wiz_0_1 : entity is true;
end MainDesign_clk_wiz_0_1;

architecture STRUCTURE of MainDesign_clk_wiz_0_1 is
begin
inst: entity work.MainDesign_clk_wiz_0_1_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out10_0 => clk_out10_0
    );
end STRUCTURE;
