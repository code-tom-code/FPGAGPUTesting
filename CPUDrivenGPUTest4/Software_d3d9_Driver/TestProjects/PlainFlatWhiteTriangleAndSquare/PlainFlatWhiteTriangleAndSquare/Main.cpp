...
{
	printf("Plain Flat White Triangle and Square Demo\n");
	printf("\n");
	printf("Controls:\n");
	printf("None\n");
	printf("\n");
...
int main(const unsigned argc, const char* const argv[])
{
	...
	lockedVB[0].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
	lockedVB[1].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
	lockedVB[2].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
	...
	lockedVB[1].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
	lockedVB[2].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
	lockedVB[3].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
	lockedVB[4].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
	lockedVB[5].vertColor = D3DCOLOR_ARGB(255, 255, 255, 255);
