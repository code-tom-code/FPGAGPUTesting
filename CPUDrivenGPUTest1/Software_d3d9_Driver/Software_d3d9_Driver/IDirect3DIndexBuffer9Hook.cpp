...
#pragma warning(disable:4996)
	sprintf(debugObjectName, "IndexBuffer (I%u, %u indices, %u bytes)", _Format == D3DFMT_INDEX16 ? 16 : 32, _Length / (_Format == D3DFMT_INDEX16 ? sizeof(uint16_t) : sizeof(uint32_t) ), _Length);
#pragma warning(pop)
#endif
	GPUBytes = GPUAlloc(InternalLength, GPUVAT_IndexData, ConvertD3DFormatToDeviceFormat(InternalFormat)
#ifdef _DEBUG
		, debugObjectName
#endif
	);
